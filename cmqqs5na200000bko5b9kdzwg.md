...
* Download OpenSSL from https://slproweb.com/products/Win32OpenSSL.html (Choose the Win64 OpenSSL v4.0.1 version if you're using Windows and you're not sure)
...
* Type the following:
    .\openssl.exe pkcs12 -export -out server.p12 -inkey server.key -in server.crt
